...
import 'package:brewmap/core/widgets/brewmap_bottom_navigation_bar.dart';
import 'package:brewmap/features/favorites/presentation/pages/favorites_page.dart';
import 'package:brewmap/features/maps/presentation/pages/maps_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: IndexedStack(
        ...
        children: [MapsPage(), FavoritesPage(), SettingsPage()],
      ),
    );
  }
}
